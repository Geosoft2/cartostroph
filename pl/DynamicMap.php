...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
	<head>
		...
		<title>Cartostroph | Dane geograficzne</title>
...
<!-- Dropdown-Eingeloggt-Feld -->
	...
	<div class="large-8 columns" >
		...
		<table>
				...
				<tr><th>Tytuł:</th> <th id="Titel"></th></tr>
				<tr><th>Autor:</th> <th id="Autor"></th></tr>
				<tr><th>Komentarz:</th> <th id="Commen"></th></tr>
                <tr><th>Średnia ocena:</th> <th id="DBewertung"></th></tr>
				<tr><th>Kategoria:</th> <th id="Kategorie"></th></tr>
				<tr><th>Hyperlącza:</th> <th id="Hyperlinks"></th></tr>
				<tr><th>Tagi:</th> <th  id="tag"></th></tr>
				<tr><th>Data początkowa:</th> <th  id="Startdatum"></th></tr>
				<tr><th>Data końcowa:</th> <th  id="Enddatum"></th"></tr>
			</table>
		</div>
		...
		while ($row = pg_fetch_array($result)) {
			...
			if($startdatum == "0001-01-01") {
				$startdatum = "uniwersalna";
			}
			
			if($enddatum == "9999-12-31") {
				$enddatum = "uniwersalna";
			}
...
<div class="large-4 columns"> 
  	...
  	<p><abbr title="Hier geben Sie an wie gut Sie den Datensatzfinden.Skala von 1(sehr schlecht/unbrauchbar) bis 5(perfekt)"><img src="../img/info.png" width="15px" height="15px"/></abbr> 
		Ocena (opcjonalnie): <br /><input id="checkbox1" checked="true" name="checkbox1" type="checkbox" onclick="activateAssessment()"><label for="checkbox1" >Wyłączyć ocenę</label>
  		<div class="row">
  		...
  		<span id="sliderOutput3"></span>
			...
			<a style="text-align: right ;position: relative ; font-size: 100%" data-reveal-id="BboxModal" class="button tiny" >Rozmieszczenie przestrzennene</a><br /><br />
