...
<body>
    ...
    <div id="login-dropdown" class="f-dropdown small content" data-dropdown-content="true" width="10%">
        ...
        <form id="top-nav-login" action="login.php" method="post">
            ...
            <p>You do not have an account yet? You can register one here <a onclick="test" data-reveal-id="RegisterModal">here</a></p>
        </form>
    </div>
   ...
   <b> </b>
   <p>The passwords are not identical!</p>
    <p>Please enter your information again!</p>
